...
(ns clojure.core.typed.test.cljs-analyzer
  {:lang :core.typed
...
(declare
  ArglistsColumnFileMap
  ConstantTableDataReadersExternsMap
  DynamicExtendTypeInvalidMethodShapeExtendingBaseJsTypeMap
  FileGroupProvidesMap
  MacrosMap
  NameMap
  alias__148544
  alias__149465
...
(t/defalias
  ...
  (t/HMap
    ...
    {:added t/Str,
     :doc t/Str,
     :private Boolean,
     :cljs.analyzer/numeric Boolean}))
(t/defalias
  ConstantTableDataReadersExternsMap
  (t/HMap
    :mandatory
    {:js-dependency-index (t/Map t/Str FileGroupProvidesMap),
     :options (t/Map t/Nothing t/Nothing),
     :cljs.analyzer/constant-table (t/Map t/Nothing t/Nothing),
     :cljs.analyzer/data-readers (t/Map t/Nothing t/Nothing),
     :cljs.analyzer/externs nil,
     :cljs.analyzer/namespaces (t/Map t/Sym NameMap)}
    :optional
    #:clojure.core.typed.test.cljs-analyzer{:namespaces
                                            (t/Map t/Sym MacrosMap)}))
(t/defalias
  DynamicExtendTypeInvalidMethodShapeExtendingBaseJsTypeMap
  '{:dynamic Boolean,
    :extend-type-invalid-method-shape Boolean,
    :extending-base-js-type Boolean,
    :fn-arity Boolean,
    :fn-deprecated Boolean,
    :fn-var Boolean,
    :infer-warning false,
    :invalid-arithmetic Boolean,
    :invalid-protocol-symbol Boolean,
    :invoke-ctor Boolean,
    :js-shadowed-by-local Boolean,
    :multiple-variadic-overloads Boolean,
    :munged-namespace Boolean,
    :ns-var-clash Boolean,
    :overload-arity Boolean,
    :preamble-missing Boolean,
    :protocol-deprecated Boolean,
    :protocol-duped-method Boolean,
    :protocol-invalid-method Boolean,
    :protocol-multiple-impls Boolean,
    :protocol-with-variadic-method Boolean,
    :redef Boolean,
    :redef-in-file Boolean,
    :single-segment-namespace Boolean,
    :undeclared-ns Boolean,
    :undeclared-ns-form Boolean,
    :undeclared-protocol-symbol Boolean,
    :undeclared-var Boolean,
    :unprovided Boolean,
    :unsupported-js-module-type Boolean,
    :unsupported-preprocess-value Boolean,
    :variadic-max-arity Boolean})
(t/defalias
  FileGroupProvidesMap
  '{:group ':goog,
    :file t/Str,
    :provides (t/Vec t/Str),
    :requires (t/U nil (t/Vec t/Str))})
(t/defalias MacrosMap '{:macros (t/Map t/Sym ArglistsColumnFileMap)})
(t/defalias NameMap '{:name t/Sym})
(t/defalias alias__148544 (t/U t/Int (t/Coll (t/U t/Int t/Sym))))
(t/defalias
  alias__149465
  (t/U clojure.lang.APersistentVector$SubVector (t/Vec t/Any)))
(t/defalias
  context
  (t/U
    '{:context ':expr,
      :build-options (t/Map t/Nothing t/Nothing),
      :column t/Int,
      :fn-scope (t/Vec t/Nothing),
      :js-globals (t/Map t/Sym NameMap),
      :line t/Int,
...
(t/defalias
  op
  (t/U
    '{:op ':constant, :env context, :form t/Int, :tag t/Sym}
    '{:op ':js,
      :args '[op op],
      :children '[op op],
      :env context,
      ...
      :segs (t/Coll t/Str),
      :tag (t/U nil t/Sym)}))
(t/ann cljs.env/*compiler* (t/Atom1 ConstantTableDataReadersExternsMap))
(t/ann *allow-ns* Boolean)
(t/ann *allow-redef* false)
(t/ann *analyze-deps* Boolean)
(t/ann *cljs-dep-set* (t/Set t/Nothing))
(t/ann *cljs-file* nil)
(t/ann *cljs-macros-is-classpath* Boolean)
(t/ann *cljs-macros-path* t/Str)
(t/ann *cljs-ns* t/Sym)
(t/ann *cljs-static-fns* false)
(t/ann *cljs-warning-handlers* '[AnyFunction])
(t/ann
  *cljs-warnings*
  DynamicExtendTypeInvalidMethodShapeExtendingBaseJsTypeMap)
(t/ann *file-defs* nil)
(t/ann *load-macros* Boolean)
(t/ann *load-tests* Boolean)
(t/ann *loop-lets* (t/Coll t/Nothing))
(t/ann *macro-infer* Boolean)
(t/ann *passes* nil)
(t/ann *recur-frames* nil)
(t/ann *reload-macros* false)
(t/ann *unchecked-if* false)
(t/ann *verbose* false)
(t/ann -cljs-macros-loaded (t/Atom1 Boolean))
(t/ann ANY_SYM t/Sym)
(t/ann BOOLEAN_OR_SEQ (t/Set t/Sym))
(t/ann BOOLEAN_SYM t/Sym)
(t/ann IGNORE_SYM t/Sym)
(t/ann NOT_NATIVE (t/Set t/Sym))
(t/ann NUMERIC_SET (t/Set t/Sym))
(t/ann SENTINEL Object)
(t/ann alias->type (t/Map t/Sym t/Sym))
(t/ann aliasable-clj-ns? AnyFunction)
(t/ann all-values? AnyFunction)
(t/ann analysis-error? AnyFunction)
(t/ann
  analyze
  (t/IFn
    [context
     (t/U t/Int (t/Coll (t/U t/Str t/Int t/Sym)))
     nil
     (t/Map t/Nothing t/Nothing)
     :->
     op]
    [context t/Int :-> op]
    [context t/Int nil :-> op]))
(t/ann
  analyze*
  [context
   (t/U t/Int (t/Coll (t/U t/Str t/Int t/Sym)))
   ...
   :->
   op])
(t/ann analyze-deps AnyFunction)
(t/ann analyze-do-statements AnyFunction)
(t/ann analyze-do-statements* AnyFunction)
(t/ann analyze-dot AnyFunction)
(t/ann analyze-file AnyFunction)
(t/ann analyze-fn-method AnyFunction)
(t/ann analyze-fn-method-body AnyFunction)
(t/ann analyze-fn-method-param AnyFunction)
(t/ann analyze-fn-methods-pass2 AnyFunction)
(t/ann analyze-fn-methods-pass2* AnyFunction)
(t/ann
  analyze-form
  [context
...
(t/ann
  analyze-form-seq
  (t/IFn
    ['[t/Int t/Int (t/Coll (t/U t/Int t/Sym))]
     (t/Map t/Nothing t/Nothing)
     :->
     nil]
    ['[t/Int t/Int (t/Coll (t/U t/Int t/Sym))] :-> nil]))
(t/ann
  analyze-js-star
  [context
   t/Str
   (t/Coll t/Int)
   (t/Coll (t/U t/Str t/Int t/Sym))
   :->
   op])
(t/ann
  analyze-js-star*
  [context
   ...
   :->
   op])
(t/ann analyze-js-value AnyFunction)
(t/ann analyze-keyword AnyFunction)
(t/ann analyze-let AnyFunction)
(t/ann analyze-let-binding-init AnyFunction)
(t/ann analyze-let-bindings AnyFunction)
(t/ann analyze-let-bindings* AnyFunction)
(t/ann analyze-let-body AnyFunction)
(t/ann analyze-let-body* AnyFunction)
(t/ann analyze-list AnyFunction)
(t/ann analyze-map AnyFunction)
(t/ann
  analyze-seq
  [context
   (t/Coll (t/U t/Str t/Int t/Sym))
...
(t/ann
  ...
  [t/Sym
   ...
   :->
   op])
(t/ann analyze-set AnyFunction)
(t/ann analyze-symbol AnyFunction)
(t/ann analyze-vector AnyFunction)
(t/ann analyze-wrap-meta AnyFunction)
(t/ann analyzed? AnyFunction)
(t/ann ast? AnyFunction)
(t/ann basic-validate-ns-spec AnyFunction)
(t/ann build-method-call AnyFunction)
(t/ann cache-analysis-ext AnyFunction)
(t/ann cache-file AnyFunction)
(t/ann canonicalize-import-specs AnyFunction)
(t/ann canonicalize-specs AnyFunction)
(t/ann check-rename-macros-inferring-missing AnyFunction)
(t/ann check-use-macros AnyFunction)
(t/ann check-use-macros-inferring-missing AnyFunction)
(t/ann check-uses AnyFunction)
(t/ann classify-dot-form AnyFunction)
(t/ann clj-ns->cljs-ns AnyFunction)
(t/ann confirm-bindings AnyFunction)
(t/ann confirm-ns AnyFunction)
(t/ann confirm-var-exist-warning AnyFunction)
(t/ann confirm-var-exists AnyFunction)
(t/ann confirm-var-exists-throw AnyFunction)
(t/ann constants-ns-sym t/Sym)
(t/ann core-name? AnyFunction)
(t/ann default-namespaces (t/Map t/Sym NameMap))
(t/ann default-warning-handler AnyFunction)
(t/ann desugar-ns-specs AnyFunction)
(t/ann elide-reader-meta AnyFunction)
(t/ann empty-env [:-> context])
(t/ann error AnyFunction)
(t/ann excluded? [context t/Sym :-> false])
(t/ann find-def-clash AnyFunction)
(t/ann find-matching-method AnyFunction)
(t/ann fn-name-var AnyFunction)
(t/ann foreign-dep? AnyFunction)
(t/ann forms-seq AnyFunction)
(t/ann forms-seq* AnyFunction)
(t/ann gen-constant-id AnyFunction)
(t/ann gen-user-ns AnyFunction)
(t/ann get-col AnyFunction)
(t/ann get-expander [t/Sym context :-> Var])
(t/ann get-expander* [t/Sym context :-> Var])
(t/ann get-expander-ns AnyFunction)
(t/ann get-js-tag [(t/Coll (t/U t/Str t/Int t/Sym)) :-> nil])
(t/ann get-let-tag AnyFunction)
(t/ann get-line AnyFunction)
(t/ann
  get-namespace
  (t/IFn
    [(t/Atom1 ConstantTableDataReadersExternsMap) t/Sym :-> NameMap]
    [t/Sym :-> NameMap]))
(t/ann get-tag [op :-> nil])
(t/ann
  gets
  (t/IFn
    [context
    ...
    [context
     ':ns
     (t/U ':excludes ':use-macros ':rename-macros)
     t/Sym
     :->
     nil]))
(t/ann has-extern? AnyFunction)
(t/ann has-extern?* AnyFunction)
(t/ann hex-format AnyFunction)
(t/ann implicit-import? AnyFunction)
(t/ann implicit-nses (t/Set t/Sym))
(t/ann infer-if AnyFunction)
(t/ann infer-invoke AnyFunction)
(t/ann infer-tag [context op :-> t/Sym])
(t/ann infer-type [context op (t/Map t/Nothing t/Nothing) :-> op])
(t/ann inferred-rename-macros AnyFunction)
(t/ann inferred-use-macros AnyFunction)
(t/ann
  intern-macros
  (t/IFn
    [t/Sym false :-> (t/U nil ConstantTableDataReadersExternsMap)]
    [t/Sym :-> (t/U nil ConstantTableDataReadersExternsMap)]))
(t/ann js-module-exists? AnyFunction)
(t/ann js-reserved (t/Set t/Str))
(t/ann js-star-interp AnyFunction)
(t/ann js-star-seg [t/Str :-> (t/Coll t/Str)])
(t/ann js-tag AnyFunction)
(t/ann js-tag? AnyFunction)
(t/ann load-core [:-> (t/U nil ConstantTableDataReadersExternsMap)])
(t/ann load-mutex Object)
(t/ann loaded-js-ns? AnyFunction)
(t/ann locate-src AnyFunction)
(t/ann macro-autoload-ns? AnyFunction)
(t/ann macro-ns-name AnyFunction)
(t/ann message AnyFunction)
(t/ann missing-rename-macro? AnyFunction)
(t/ann missing-rename? AnyFunction)
(t/ann missing-renames AnyFunction)
(t/ann missing-use-macro? AnyFunction)
(t/ann missing-use-macros AnyFunction)
(t/ann missing-use? AnyFunction)
(t/ann missing-uses AnyFunction)
(t/ann namespaces clojure.core.typed.test.cljs_analyzer$reify__61542)
(t/ann normalize-js-tag AnyFunction)
(t/ann ns-side-effects [context op (t/Map t/Nothing t/Nothing) :-> op])
(t/ann numeric-type? AnyFunction)
(t/ann parse-import-spec AnyFunction)
(t/ann parse-invoke AnyFunction)
(t/ann parse-invoke* AnyFunction)
(t/ann parse-ns AnyFunction)
(t/ann parse-ns-error-msg AnyFunction)
(t/ann parse-ns-excludes AnyFunction)
(t/ann parse-require-spec AnyFunction)
(t/ann parse-type AnyFunction)
(t/ann process-rewrite-form AnyFunction)
(t/ann property-symbol? AnyFunction)
(t/ann register-constant! AnyFunction)
(t/ann repeat-char AnyFunction)
(t/ann repl-self-require? AnyFunction)
(t/ann requires-analysis? AnyFunction)
(t/ann resolve-existing-var AnyFunction)
(t/ann resolve-macro-ns-alias AnyFunction)
(t/ann resolve-macro-var AnyFunction)
(t/ann resolve-ns-alias AnyFunction)
(t/ann resolve-symbol AnyFunction)
(t/ann resolve-var AnyFunction)
(t/ann rewrite-cljs-aliases AnyFunction)
(t/ann source-info AnyFunction)
(t/ann source-path AnyFunction)
(t/ann specials (t/Set t/Sym))
(t/ann transit clojure.lang.Delay)
(t/ann transit-read-opts nil)
(t/ann transit-write-opts nil)
(t/ann type? AnyFunction)
(t/ann use->require AnyFunction)
(t/ann used? AnyFunction)
(t/ann valid-arity? AnyFunction)
(t/ann valid-proto AnyFunction)
(t/ann var-ast AnyFunction)
(t/ann warning AnyFunction)
(t/ann write-analysis-cache AnyFunction)
(t/ann
  clojure.tools.reader/*alias-map*
  (t/U nil (t/Map t/Nothing t/Nothing)))
                      ...
                      [k (as-> (meta v) vm
                           (let [ns (.getName ^Namespace (:ns vm))]
                             (assoc vm
                               ...
                               :macro true)))])
                    ['[t/Sym Var] :-> '[t/Sym ArglistsColumnFileMap]])
                  )
             (into {}))))))
      ...
      ;else
        (if-some [mac-var (when (symbol? op) (get-expander op env))]
          (#?@(:clj [binding [*ns* (create-ns *cljs-ns*)]]
               :cljs [do])
            (let [mchk  #?(:clj  (some-> (or (find-ns 'clojure.spec.alpha)
...
(defn analyze* [env form name opts]
  (let [passes *passes*
    ...
    (reduce (t/ann-form
              (fn [ast pass] (pass env ast opts))
              [op [context op (t/Map t/Nothing t/Nothing) :-> op] :-> op])
             ast passes)))
  ...
  ([forms opts]
   (let [env (assoc (empty-env) :build-options opts)]
     (binding [*file-defs* nil
       ...
       (loop [^{::t/ann nil} ns nil ^{::t/ann (t/U nil (t/Coll alias__148544))} forms forms]
         (if (some? forms)
