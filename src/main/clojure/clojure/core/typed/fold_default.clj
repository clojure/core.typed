(ns clojure.core.typed.fold-default
  ...
  (:import (clojure.core.typed.type_rep NotType DifferenceType Intersection Union FnIntersection Bounds
                                        ...
                                        BooleanCLJS AssocType KwArgsSeq HSequential HSet)
           ...
           (clojure.core.typed.path_rep KeyPE KeysPE ValsPE ClassPE FirstPE)))
...
(add-default-fold-case FirstPE ret-first)
