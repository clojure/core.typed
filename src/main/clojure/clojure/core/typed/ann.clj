...
(ann clojure.core/re-groups [java.util.regex.Matcher -> (U nil String (APersistentVector (Option String)))])
(ann clojure.core/re-find (Fn [java.util.regex.Matcher -> (U nil String (APersistentVector (Option String)))]
