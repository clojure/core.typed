...
(ns ^{:doc "A caching library for Clojure."
  ...
  (:require clojure.core.typed.deps.clojure.data.priority-map)
...
(defn through
  ...
  ([wrap-fn value-fn cache item]
    (if (clojure.core.typed.deps.clojure.core.cache/has? cache item)
      (clojure.core.typed.deps.clojure.core.cache/hit cache item)
      (clojure.core.typed.deps.clojure.core.cache/miss cache item (wrap-fn #(value-fn %) item)))))
...
(defn- build-leastness-queue
  [base limit start-at]
  (into (clojure.core.typed.deps.clojure.data.priority-map/priority-map)
...
(defn fifo-cache-factory
  ...
  (clojure.core.typed.deps.clojure.core.cache/seed (FIFOCache. {} clojure.lang.PersistentQueue/EMPTY threshold) base))
...
(defn lru-cache-factory
  ...
  {:pre [(number? threshold) (< 0 threshold)
         (map? base)]}
  (clojure.core.typed.deps.clojure.core.cache/seed (LRUCache. {} (clojure.core.typed.deps.clojure.data.priority-map/priority-map) 0 threshold) base))
...
(defn ttl-cache-factory
  ...
  {:pre [(number? ttl) (<= 0 ttl)
         (map? base)]}
  (clojure.core.typed.deps.clojure.core.cache/seed (TTLCache. {} {} ttl) base))
...
(defn lu-cache-factory
  ...
  {:pre [(number? threshold) (< 0 threshold)
         (map? base)]}
  (clojure.core.typed.deps.clojure.core.cache/seed (LUCache. {} (clojure.core.typed.deps.clojure.data.priority-map/priority-map) threshold) base))
