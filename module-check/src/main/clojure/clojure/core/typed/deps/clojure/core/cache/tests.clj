...
(ns ^{:doc "A caching library for Clojure."
      :author "Fogus"}
  clojure.core.typed.deps.clojure.core.cache.tests
  (:use [clojure.core.typed.deps.clojure.core.cache] :reload-all)
  (:use [clojure.test])
  (:import (clojure.core.typed.deps.clojure.core.cache BasicCache FIFOCache LRUCache TTLCache LUCache
                               LIRSCache)
...
(deftest test-lru-cache
  ...
  (testing "regressions against LRU eviction before threshold met"
    (is (= {:b 3 :a 4}
           (-> (clojure.core.typed.deps.clojure.core.cache/lru-cache-factory {} :threshold 2)
               (assoc :a 1)
               (assoc :b 2)
               (assoc :b 3)
               (assoc :a 4)
    ...
    (is (= {:e 6, :d 5, :c 4}
           (-> (clojure.core.typed.deps.clojure.core.cache/lru-cache-factory {} :threshold 3)
               (assoc :a 1)
               (assoc :b 2)
               (assoc :b 3)
               (assoc :c 4)
...
(deftest test-lu-cache
  ...
  (testing "regressions against LRU eviction before threshold met"
    (is (= (-> (clojure.core.typed.deps.clojure.core.cache/lu-cache-factory {} :threshold 2)
               (assoc :a 1)
               (assoc :b 2)
               (assoc :b 3)
               (assoc :a 4))
    ...
    (is (= (-> (clojure.core.typed.deps.clojure.core.cache/lu-cache-factory {} :threshold 3)
               (assoc :a 1)
               (assoc :b 2)
               (assoc :b 3)
               (assoc :c 4)
    ...
    (is (= {:a 1 :b 3}
           (-> (clojure.core.typed.deps.clojure.core.cache/lu-cache-factory {} :threshold 2)
               (assoc :a 1)
               (assoc :b 2)
               (assoc :b 3)
               .cache)))))
