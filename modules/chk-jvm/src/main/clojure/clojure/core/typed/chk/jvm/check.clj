(ns ^:skip-wiki 
  ...
  (:require [clojure.core.typed :as t :refer [*already-checked* letfn>]]
            ...
            [clojure.core.typed.chk.common.filter-protocols :as fprotocol]
            ...
            [clojure.core.typed.chk.common.cs-gen :as cgen]
            ...
            [clojure.core.typed.chk.common.tvar-env :as tvar-env]
            [clojure.core.typed.chk.common.tvar-bnds :as tvar-bnds]
            ...
            [clojure.core.typed.chk.jvm.array-ops :as arr-ops]
            ...
            [clojure.core.typed.chk.common.mm-env :as mm]
            [clojure.core.typed.chk.jvm.rclass-env :as rcls]
            [clojure.core.typed.chk.common.protocol-env :as pcl-env]
            [clojure.core.typed.chk.jvm.method-param-nilables :as mtd-param-nil]
            [clojure.core.typed.chk.jvm.method-return-nilables :as mtd-ret-nil]
            [clojure.core.typed.chk.jvm.method-override-env :as mth-override]
            [clojure.core.typed.chk.jvm.ctor-override-env :as ctor-override]
            [clojure.core.typed.chk.jvm.analyze-clj :as ana-clj]
            [clojure.core.typed.chk.common.ns-deps :as ns-deps]
  ...
  (:import (clojure.core.typed.chk.common.lex_env PropEnv)
...
(t/ann ^:no-check clojure.core.typed.chk.common.parse-unparse/*unparse-type-in-ns* (U nil Symbol))
...
(add-invoke-special-method 'clojure.core.typed.chk.common.inst-poly
...
(add-invoke-special-method 'clojure.core.typed.chk.common.inst-poly-ctor
                        ...
                        (let [expected-ifn (datatype-method-expected dt method-sig)]
                          ...
                          (lex/with-locals expected-fields
                            (free-ops/with-free-mappings 
                              ...
                              ;     (into {} (for [[k {:keys [name]}] clojure.core.typed.chk.common.tvar-env/*current-tvars*]
                              ;                [k name])))
                              ;(prn "bnds when checking method" 
                              ;     clojure.core.typed.chk.common.tvar-bnds/*current-tvar-bnds*)
