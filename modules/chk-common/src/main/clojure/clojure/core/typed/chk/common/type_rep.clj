...
(defn- -FS-var []
  (impl/the-var 'clojure.core.typed.chk.common.filter-ops/-FS))

(t/ann ^:no-check -top-var [-> (t/Var1 p/IFilter)])
(defn -top-var []
  (impl/the-var 'clojure.core.typed.chk.common.filter-rep/-top))

(t/ann ^:no-check -empty-var [-> (t/Var1 p/IRObject)])
(defn -empty-var []
  (impl/the-var 'clojure.core.typed.chk.common.object-rep/-empty))
