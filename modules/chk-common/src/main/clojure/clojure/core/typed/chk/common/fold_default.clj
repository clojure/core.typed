(ns clojure.core.typed.chk.common.fold-default
  (:require [clojure.core.typed.chk.common.fold-rep :refer [add-default-fold-case]]
...
(add-default-fold-case Union 
                       (fn [ty _]
                         ;(prn "union default" (clojure.core.typed.chk.common.parse-unparse/unparse-type ty))
...
(add-default-fold-case DataType
                       (fn [ty _]
                         ;(prn "datatype default" (clojure.core.typed.chk.common.parse-unparse/unparse-type ty))
                         (-> ty
                           (update-in [:poly?] #(when %
                                                  (mapv type-rec %)))
