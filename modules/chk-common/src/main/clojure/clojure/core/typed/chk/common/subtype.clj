...
(defn resolve-JS-reference [sym]
  ...
  (cond
    ...
    :else (let [{{:keys [protocol-symbol name]} :info} ((impl/v 'clojure.core.typed.impl.js.analyze-cljs/analyze-qualified-symbol) sym)]
            (if protocol-symbol
...
(defn protocol-extenders [^Protocol p]
  ...
  (impl/impl-case
    ...
    :cljs (let [exts ((impl/v 'clojure.core.typed.impl.js.analyze-cljs/extenders) (:the-var p))]
            (for [ext exts]
              (cond
