(ns ^:skip-wiki clojure.core.typed.chk.common.parse-unparse
...
(defn- Mu*-var []
  (let [v (ns-resolve (find-ns 'clojure.core.typed.chk.common.type-ctors) 'Mu*)]
...
(defn- RClass-of-var []
  (let [v (ns-resolve (find-ns 'clojure.core.typed.chk.common.type-ctors) 'RClass-of)]
