...
;(clojure.core.typed.chk.common.subtype/sub-clj? [Point -> Number]
;                                     ['{:lat Number} -> Number])
;
;(clojure.core.typed.chk.common.subtype/sub-clj? ['{:lat Number} -> Number]
;                                     [Point -> Number])
;
;(clojure.core.typed.chk.common.subtype/sub-clj? '{:lat Number}
;                                     Point)
;
;(clojure.core.typed.chk.common.subtype/sub-clj? Point
;                                     '{:lat Number})
